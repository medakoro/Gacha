...
print("カウント:リセット完了 確率:",input_chance/1000,"[%]",input_powerup,"[凸]","回数:",input_count_simulate)
print("計算を開始します")
...
if input_count_simulate >= 1:
    #平均
    print("=====================AVERAGE==================")
    print("\033[49m集計終了 試行回数:",input_count_simulate,"| 平均必要ガチャ回数:",count/input_count_simulate,"回 10連換算:",count/10/input_count_simulate,"回 すり抜け回数:",count_passing/input_count_simulate,"回 当選回数:",count_correct/input_count_simulate,"回 天井回数:",count_roof/input_count_simulate,"回\033[49m")
    print("必要ポリクローム:約",need_polychrome/input_count_simulate,"個 必要課金額:約¥",need_money/input_count_simulate," 課金回数:約",math.ceil(need_polychrome/6480/input_count_simulate),"回\033[49m")
